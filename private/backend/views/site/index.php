            ...
            <div class="container recent-boxes">
                ...
                <div class="row">
                    <div class="col-lg-12 recent-box">
                        ...
                        <p class="text-center show-loading">
							<?php
							if ( Yii::$app->user->can( 'manager' ) ) {
								echo Html::a( Yii::t( 'back', 'Manage menu items' ), [ 'menu-item/index' ],
									[ 'class' => 'btn btn-primary' ] ) . ' ';
								echo Html::a( Yii::t( 'back', 'Manage categories' ), [ 'category/index' ],
									[ 'class' => 'btn btn-primary' ] ) . ' ';
							}
							echo Html::a( Yii::t( 'back', 'Manage photo galleries' ), [ 'gallery/index' ],
								[ 'class' => 'btn btn-primary' ] ) . ' ';
							echo Html::a( Yii::t( 'back', 'Manage polls' ), [ 'poll/index' ],
								[ 'class' => 'btn btn-primary' ] ) . ' ';
							echo Html::a( Yii::t( 'back', 'Manage images' ), [ 'file/images' ],
								[ 'class' => 'btn btn-primary' ] ) . ' ';
							echo Html::a( Yii::t( 'back', 'Manage files' ), [ 'file/files' ],
								[ 'class' => 'btn btn-primary' ] );
							?>
                        </p>
                    </div>
